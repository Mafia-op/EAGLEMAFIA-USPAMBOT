...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await idk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@KINGBOTOFFICIALCHAT"))
...
print(text)
print("")
print("Pawri💥! Your KINGBOT SPAM BOT IS DEPLOYED AND WORKING ⚡⚡ ENJOY SPAM ⚡SUPPORT⚡ - @KINGBOTOFFICIAL.")
