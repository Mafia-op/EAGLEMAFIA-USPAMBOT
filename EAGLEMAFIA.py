...
from Config import API_ID, API_HASH, STRING, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, BIO_MESSAGE, SUDO_USERS, OWNER_ID, OWNER_NAME
